...
export const wrongMethod = () => res.status(405).json({ message: "Method Not Allowed" });
export const unauthorized = () => res.status(401).json({ message: "Unauthorized" });
export const missingFields = () => res.status(400).json({ message: "Bad Request - Missing required fields" });
